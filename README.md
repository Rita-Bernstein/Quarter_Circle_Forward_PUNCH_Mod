...
3. Translation of the mod's created text so far to PT-BR.
4. Relics inspired by Honda, Dhalsim, Blanka and Zangief.
5. Translation of the mod's created text so far to PT-BR.
...
7. Translation of the mod's created text so far to PT-BR.
...
10. Translation of the mod's created text so far to PT-BR.
11. Relics inspired by Cammy, Fei Long and Deejay.
12. Translation of the mod's created text so far to PT-BR.
13. ?????????????????????
14. Update of art and sound assets.
15. Polishing, refactoring and balancing.
16. Challenges for Custom Games where you start with a specific Street Fighter's relics (and problems)
17. Synergy and adaptation with other mods.
