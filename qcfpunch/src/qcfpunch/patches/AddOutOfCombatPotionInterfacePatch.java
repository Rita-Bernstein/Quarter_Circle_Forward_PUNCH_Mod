				...
				{				
					try {
						...
						if (i.getType().getName().toString().equals("com.megacrit.cardcrawl.potions.FruitJuice"))
							...
							i.replace("$_ = $proceed($$) || this.potion instanceof qcfpunch.potions.OutOfCombatPotion;");
				...
				{				
					try {
						...
						if (i.getType().getName().toString().equals("com.megacrit.cardcrawl.potions.FruitJuice"))
							...
							i.replace("$_ = $proceed($$) || (this.potion instanceof qcfpunch.potions.OutOfCombatPotion && this.potion.canUse());");
